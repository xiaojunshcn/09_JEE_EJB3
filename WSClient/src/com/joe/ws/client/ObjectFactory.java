 ...
 * generated in the com.joe.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrders_QNAME = new QName("http://ws.joe.com", "getOrders");
    private final static QName _GetUserName_QNAME = new QName("http://ws.joe.com", "getUserName");
    private final static QName _GetOrder_QNAME = new QName("http://ws.joe.com", "getOrder");
    private final static QName _GetOrderResponse_QNAME = new QName("http://ws.joe.com", "getOrderResponse");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://ws.joe.com", "getOrdersResponse");
    private final static QName _GetUserNameResponse_QNAME = new QName("http://ws.joe.com", "getUserNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.joe.ws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.joe.com", name = "getOrders")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.joe.com", name = "getUserName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.joe.com", name = "getOrder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.joe.com", name = "getOrderResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.joe.com", name = "getOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.joe.com", name = "getUserNameResponse")
